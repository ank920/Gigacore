                ...
                <SectionWrapper>
                    <div className="flex flex-col lg:flex-row gap-8 md:gap-12 items-center">
                        <div className="flex-1 w-full">
                            <div className="rounded-2xl overflow-hidden shadow-[0_4px_30px_rgba(0,0,0,0.1)] border border-gray-100">
                                <img
                ...
                <SectionWrapper>
                    <div className="flex flex-col lg:flex-row-reverse gap-8 md:gap-12 items-center">
                        ...
                        <div className="flex-1">
                            ...
                            <h2 className="text-[length:var(--font-h1)] font-bold mb-6 text-brand-secondary">Gigacore Energy: Demonstrated <span className="text-gradient-green-glow">Energy Reduction</span></h2>
                            <p className="text-lg text-gray-600 mb-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                <div className="p-6 bg-white rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-gray-100 hover:border-brand-primary/30 transition-colors">
                                    <div className="text-4xl font-bold text-brand-secondary mb-2">~22</div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 md:gap-12 items-center">
                        ...
                        <div className="flex-1 space-y-8">
                            <div className="bg-white p-8 rounded-3xl border border-brand-primary/10 shadow-[0_10px_40px_rgba(0,213,99,0.08)]">
                                <h3 className="text-xl font-bold text-brand-secondary mb-6">Cost Model Estimates</h3>
                                <ul className="space-y-6">
                                    ...
                                    <li className="flex justify-between items-center border-b border-brand-primary/10 pb-4">
                                        <span className="text-brand-secondary font-bold">Gigacore (at ~15 kWh/kg)</span>
                            ...
                            <p className="text-sm text-gray-500 italic pl-4 border-l-2 border-gray-100">
                ...
                <SectionWrapper>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24 items-stretch">
                        ...
                        <div className="flex flex-col h-full">
                            ...
                            <div className="rounded-2xl overflow-hidden shadow-md border border-gray-100 mt-auto h-72 w-full">
                                <img
                            ...
                            <div className="bg-white p-8 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-brand-primary/10 mb-8 hover:shadow-[0_4px_20px_rgba(0,213,99,0.08)] transition-all">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center">
                                    <div className="relative">
                                        <div className="text-3xl font-bold text-brand-secondary mb-1">25–50</div>
                                    ...
                                    <div>
                                        <div className="text-3xl font-bold text-brand-secondary mb-1">250–500</div>
                    ...
                    <div className="flex flex-col lg:flex-row-reverse gap-8 md:gap-12 items-center">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="p-5 bg-white rounded-xl border border-gray-100 hover:border-brand-primary/30 transition-all">
                                    <h4 className="font-bold text-brand-secondary mb-1">Industrial Substitution</h4>
                                    <p className="text-gray-600 text-sm font-medium">Refining and chemicals replacement</p>
                                </div>
                                <div className="p-5 bg-white rounded-xl border border-gray-100 hover:border-brand-primary/30 transition-all">
                                    <h4 className="font-bold text-brand-secondary mb-1">On-site Generation</h4>
                        ...
                        <div>
                            ...
                            <ul className="space-y-6">
                                <li className="flex gap-4 p-6 bg-brand-light rounded-2xl border border-brand-primary/5">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-brand-secondary text-lg">Grounded Data</h4>
                                ...
                                <li className="flex gap-4 p-6 bg-brand-light rounded-2xl border border-brand-primary/5">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-brand-secondary text-lg">Future Validation</h4>
                            ...
                            <div className="mt-12">
                                <h3 className="text-xl font-bold mb-6 text-brand-secondary">Economic Positioning</h3>
